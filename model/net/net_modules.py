...
def compute_mean_std(x:tf.Tensor, epsilon=1e-5):
    axes = [1, 2]
...
class AdaIN(keras.Layer):
    ...
    def call(self, content:tf.Tensor, style=tf.Tensor, alpha=1):
...
class Encoder(keras.Model):
    ...
    def call(self, inputs, return_only_last=False):
        # relu4_1
        block4 = keras.Model(
...
class Decoder(keras.Model):
    def __init__(self, input_shape=(None, None, 512)):
        super().__init__()
        self.input_shape = input_shape
